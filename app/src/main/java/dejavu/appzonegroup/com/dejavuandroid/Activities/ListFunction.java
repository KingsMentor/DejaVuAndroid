 ...
 */
public class ListFunction extends Fragment implements onScreen {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) rootView.findViewById(R.id.function_list);
        ...
        for (int index = 0; index < listModelArrayList.size(); index++) {
            AdapterArrayList.add(listModelArrayList.get(index).getName());
        }
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, AdapterArrayList) {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (listModelArrayList.get(position).isFlow()) {
                    Log.e("id : ",listModelArrayList.get(position).getID());
    ...
    public void loadFlow(String JsonString) {
        ...
        StepParceble stepParceble = new StepParceble(initStep, new JSONObject(), ListFunction.this);
    ...
    public void onScreen() {
        //  getActivity().getActionBar().setDisplayOptions(ActionBar.DISPLAY_USE_LOGO | ActionBar.DISPLAY_SHOW_TITLE);
        //getActivity().getActionBar().setTitle("Zone App");
    }
}